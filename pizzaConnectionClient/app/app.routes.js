...
var order_history_routes_1 = require('./order-history/ts/routes/order-history.routes');
exports.routes = pizza_routes_1.PizzaRoutes.concat(cart_routes_1.CartRoutes, checkout_routes_1.CheckoutRoutes, order_option_routes_1.OrderOptionRoutes, login_routes_1.LoginRoutes, confirmation_routes_1.ConfirmationRoutes, account_creator_routes_1.AccountCreatorRoutes, order_history_routes_1.OrderHistoryRoutes);
